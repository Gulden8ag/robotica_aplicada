...
![Gazebo Shapes World](../M0_Fundamentals_and_Tools/Images/gazebo_shapes_world.png){width="80%"}
...
![Gazebo Sim](../M0_Fundamentals_and_Tools/Images/gazebo_sim.png){width="80%"}

Use any example to test.

## Install extension for VS Code

![ROS Extension](../M0_Fundamentals_and_Tools/Images/vscode_extesion.png){width="80%"}
...
code .
``` 
in your WSL terminal. And then install the extension from that window.
...
![Bashrc VSCode](../M0_Fundamentals_and_Tools/Images/source_bash.png){width="80%"}
